    ...
    return (
      <View>
        <ScrollView>
          ...
          >
            <Text style={{ fontSize: 38, textAlign: "center", margin: 20 }}>
              {questions.questions[this.props.id - 1].question}
            </Text>
            <View style={{ flexDirection: "column" }}>
              ...
              >
                {questions.questions[this.props.id - 1].description}
              </Text>
            </View>
          </View>
          <View
          ...
          >
            <TouchableOpacity>
              <AntDesign name="upcircle" size={64} color="#000" />
            </TouchableOpacity>
          </View>
